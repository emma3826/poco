...
rem Change POCO_MYSQL_DIR to match your setup
set POCO_MYSQL_DIR=C:\PROGRA~1\MySQL\MYSQLS~1.5
set POCO_MYSQL_INCLUDE=%POCO_MYSQL_DIR%\include
set POCO_MYSQL_LIB=%POCO_MYSQL_DIR%\lib
set INCLUDE=%INCLUDE%;%POCO_MYSQL_INCLUDE%
set LIB=%LIB%;%POCO_MYSQL_LIB%
